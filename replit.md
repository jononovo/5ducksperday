...
- June 14, 2025. Comprehensive individual merge field highlighting system: Implemented sophisticated overlay-based highlighting that highlights individual resolved merge variables (e.g., "Boston Centerless" when from {{company_name}}) rather than entire fields. Created HighlightedInput and HighlightedTextarea components with transparent input overlays and HTML content rendering, proper cursor positioning, scroll synchronization, and form functionality preservation. Integrated with merge field resolver supporting 13+ variables with contextual data from selected contacts and companies
