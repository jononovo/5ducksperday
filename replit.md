...
- June 15, 2025. Mobile search type selector spacing fix: Added mt-4 top margin to search type selector wrapper for optimal spacing. Selector positioned slightly below contact chips baseline with proper distance from search button above
