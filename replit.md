...
- June 14, 2025. Button size standardization: Updated "Insert Template" button to match smaller sizing (h-8 px-3 text-xs) and consistent hover animation (scale-105) used by other action buttons in Quick Templates section
