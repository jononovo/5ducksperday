...
- July 17, 2025. **Pricing Page Credit Information Enhancement**: Added prominent "How Credits Work" section above FAQ with 3-column layout featuring large credit numbers (10, 70, 240) matching user's design requirements. Section includes Company Search (10 credits), Company + Contacts (70 credits), Company + Contacts + Emails (240 credits), plus additional "Full Email Search across all Databases" (20 credits) information. Used large 6xl font sizing for credit numbers with blue accent colors and clean typography. Section positioned as standalone with same title styling as FAQ for proper prominence.
