          ...
          {companies.map((company) => {
            ...
            return (
              <React.Fragment key={`company-${company.id}`}>
                ...
                <TableRow 
                  className={`cursor-pointer hover:bg-blue-50/70 dark:hover:bg-blue-800/40 hover:opacity-100 bg-transparent ${isExpanded ? 'h-5 opacity-50' : 'h-10 opacity-100'} transition-all duration-200`}
