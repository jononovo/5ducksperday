            ...
            <AnimatePresence mode="wait">
              {!showGoogleAuthInfo ? (
                ...
                >
                  <Button 
                    variant="outline"
                    className="w-full justify-between relative bg-blue-500/20 text-white border-2 border-blue-400 hover:bg-blue-500/30 hover:border-blue-300 hover:text-white hover:font-semibold shadow-sm"
