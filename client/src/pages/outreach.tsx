    ...
    <div className="w-full md:container md:mx-auto md:py-8">
      ...
      <div className="md:hidden pt-0">
        ...
        {!isMobileExpanded && currentCompany && selectedContact && (
          <div className="md:hidden px-2.5 py-0.5 -mt-4 bg-white flex items-center justify-between z-[60]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
        ...
        <div className={`md:block ${isMobileExpanded ? 'mt-4' : ''}`}>
          <div className="md:border md:rounded-lg md:shadow-sm">
            ...
            <div className={`p-6 space-y-6 ${!showExpandedView && selectedContact ? 'pt-8' : ''}`}>
              {/* Email Prompt Field */}
