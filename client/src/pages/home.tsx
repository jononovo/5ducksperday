  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] overflow-hidden relative">
      ...
      <div className={`email-drawer-transition ${
        emailDrawerOpen 
          ? 'fixed md:relative top-[2.5rem] md:top-0 right-0 bottom-auto max-h-[calc(100vh-2.5rem)] md:max-h-screen w-[90%] sm:w-[400px] md:w-[400px] lg:w-[450px] xl:w-[500px] z-50 md:z-auto' 
          : 'md:relative w-0'
      } overflow-hidden border-l border-t border-b rounded-tl-lg rounded-bl-lg bg-background shadow-xl md:shadow-none`}>
