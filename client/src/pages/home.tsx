  ...
  return (
    <div className="flex h-[calc(100vh-3.5rem)] overflow-hidden relative">
      ...
      <div className={`email-drawer-transition ${
        emailDrawerOpen 
          ? 'fixed md:absolute top-[2.5rem] md:top-0 right-0 bottom-auto max-h-[calc(100vh-2.5rem)] md:max-h-screen w-[90%] sm:w-[400px] md:w-[400px] lg:w-[450px] xl:w-[500px] z-50 md:z-50' 
          : 'md:absolute w-0 right-0 top-0'
