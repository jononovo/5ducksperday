                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="flex flex-col md:flex-row items-end justify-center md:pl-20">
                      ...
                      <h3 className="relative z-10 text-4xl md:text-6xl font-serif italic leading-[1.1] text-white max-w-2xl text-left drop-shadow-2xl -mb-8 md:-mb-0 md:-mr-24 pointer-events-none">
                        &ldquo;{testimonials[currentTestimonialIndex].quote}&rdquo;
                      </h3>

                      <div className="relative z-20 flex items-center gap-5 bg-[#151520] border border-white/10 p-6 pr-10 rounded-2xl shadow-2xl md:-translate-y-8 shrink-0 mt-8 md:mt-0">
