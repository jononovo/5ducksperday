...
export class DatabaseStorage implements IStorage {
  ...
  async getListsByCampaign(campaignId: number): Promise<List[]> {
    ...
    return db.select().from(lists).where(eq(lists.listId, listIds[0])); // Need to handle multiple listIds
  }
      ...
      const defaultApproaches = [
        {
          ...
          prompt:
            "Provide a detailed overview of [COMPANY], including its age, size, and main business focus.",
          order: 1,
          active: true,
          ...
          technicalPrompt:
            "Analyze company details focusing on age, size, and core business activities.",
          responseStructure: "JSON with fields: age, size, mainFocus",
        },
        {
          name: "Decision-maker Analysis",
          prompt:
            "Identify and analyze the key decision-makers at [COMPANY]. Focus on C-level executives, owners, founders, and other top-level decision-makers. Include their roles and any available contact information.",
          order: 2,
          active: true,
          ...
          technicalPrompt:
            "Identify key decision-makers at [COMPANY], including roles and contact information.",
          responseStructure: "JSON with fields: decisionMakers",
        },
        {
          name: "Email Discovery",
          prompt:
            "Find contact information and email addresses for leadership and key decision makers at [COMPANY].",
          order: 3,
          active: true,
          moduleType: "decision_maker",
          config: {
            ...
            searchSections: {
              local_sources: {
                ...
                label: "Local Sources",
                description:
                  "Search local sources for company and contact information",
                searches: [
                  {
                    id: "local-news-search",
                    label: "Local News Search",
                    description:
                      "Search local news sources for company leadership mentions and activities",
                    implementation:
                      "Search local news for [COMPANY] leadership mentions",
                  },
                  {
                    id: "business-associations-search",
                    label: "Business Associations Search",
                    description:
                      "Search local chambers of commerce and business association memberships",
                    implementation:
                      "Search business associations for [COMPANY] memberships",
                  },
                  {
                    id: "local-events-search",
                    label: "Local Events Search",
                    description:
                      "Search local business events, conferences, and speaking engagements",
                    implementation:
                      "Find [COMPANY] participation in local events",
                  },
                  {
                    id: "local-classifieds-search",
                    label: "Local Classifieds or Lists",
                    description:
                      "Search classifieds for company info and local classifieds",
                    implementation:
                      "Search local classifieds for [COMPANY] information",
                  },
                ],
              },
              digital_sources: {
                ...
                searches: [
                  {
                    ...
                    description:
                      "Search Google My Business listings and reviews",
                ...
                searches: [
                  {
                    ...
                    description:
                      "Search LinkedIn for company profiles and employees",
                    implementation:
                      "Search LinkedIn for [COMPANY] profile and employees",
                  },
                  {
                    id: "twitter-search",
                    label: "Twitter Search",
                    description:
                      "Search Twitter for social mentions and engagement",
                  ...
                  },
                  {
                    ...
                    description:
                      "Search Facebook for social presence and community engagement",
                ...
                searches: [
                  {
                    ...
                    label: "Angelist",
                    description:
                      "Search Angelist for startup information and funding details",
                  ...
                  },
                  {
                    ...
                    label: "Crunchbase",
                    description:
                      "Search Crunchbase for company data and investment history",
                  ...
                  },
                  {
                    ...
                    label: "Other Sources",
                    description:
                      "Search other startup-focused platforms and databases",
                ...
                searches: [
                  {
                    ...
                    label: "Tech Startup",
                    description:
                      "Search for technology startup listings and directories",
                    implementation:
                      "Search tech startup directories for [COMPANY]",
                  },
                  {
                    id: "small-business-listings",
                    label: "Small Business",
                    description:
                      "Search for small business listings and directories",
                    implementation:
                      "Search small business directories for [COMPANY]",
                  },
                  {
                    id: "contractor-listings",
                    label: "Contractor",
                    description:
                      "Search for contractor and service provider listings",
                    implementation:
                      "Search contractor directories for [COMPANY]",
                  },
                ],
              },
            },
          ...
          technicalPrompt:
            "Discover contact information and email addresses for leadership and key decision-makers at [COMPANY].",
          responseStructure: "JSON with fields: emails",
        },
        {
          name: "Market Position",
          prompt:
            "Analyze the market position, success metrics, and industry standing of [COMPANY].",
          order: 4,
          active: true,
          moduleType: "company_overview",
          config: {
          ...
          technicalPrompt:
            "Analyze the market position, success metrics, and industry standing of [COMPANY].",
          responseStructure:
            "JSON with fields: marketPosition, successMetrics, industryStanding",
        },
        {
          name: "Customer Base",
          prompt:
            "Research and describe the customer base, target market, and market reach of [COMPANY].",
          order: 5,
          active: true,
          moduleType: "company_overview",
          config: {
          ...
          technicalPrompt:
            "Research and describe the customer base, target market, and market reach of [COMPANY].",
          responseStructure:
            "JSON with fields: customerBase, targetMarket, marketReach",
        },
      ];
